...
:::tip 推荐
推荐您参考这篇[Springboo集成demo](/pages/12283a/),可帮助您节省您更多时间.
:::
## 初始化工程
...
:::tip
Latest Version: [点此获取](https://img.shields.io/github/v/release/xpc1024/easy-es?include_prereleases&logo=xpc&style=plastic)
:::
...
```
:::tip
上面完整的代码示例请移步：[Easy-Es-Sample](https://gitee.com/easy-es/easy-es/tree/master/easy-es-sample/src/test/java/com/xpc/easyes/sample/test)
:::
