...
notices: # 可选的
    - id: Easy-Es-3.0.2
      title: 🚀 Easy-Es v3.0.2 发布！
      content: '<div><ul><li>2026-01</li><li> 欢迎试用! </ul></div><p style="text-align: right;"><a href="/pages/5b34d2/">查看详情</a></p>'
      isHtmlContent: true
---
...
- name: 皓臻 AI
  desc: 汇聚国内外顶尖编程模型超低成本提效,只要一杯☕️拥有更多摸🐟时间
